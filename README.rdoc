...
For pure demonstration and testing purposes, there is a very simple Silverlight 4-based unit converter application included in the solution, SilverlightUnitConverter. Implementation of this application was inspired by Andrew Cheng's feedback and usage of uomnet in his Windows Forms application.


== Links

* On-line version of the SilverlightUnitConverter application: http://www.cureos.com/uomnet
* Andrew Cheng's Winform unit converter: https://github.com/hamxiaoz/cureos.uomnet.tests.winform


== Revision

Last updated on March 25, 2011 by Anders Gustafsson, anders[at]cureos[dot]com, http://www.cureos.com.
