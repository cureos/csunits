...
{
	public class SpecificMeasure<Q> : IMeasure<Q>, IEquatable<SpecificMeasure<Q>>, IComparable<SpecificMeasure<Q>> where Q : struct, IQuantity<Q>
	{
		...
		public SpecificMeasure(double iAmount, IUnit<Q> iUnit)
		{
		...
		public SpecificMeasure(decimal iAmount, IUnit<Q> iUnit)
		{
			if (iUnit == null) throw new ArgumentNullException("iUnit");
#if DECIMAL
			mAmount = iAmount;
		...
		///                 </param>
		public int CompareTo(SpecificMeasure<Q> other)
		{
		...
		public bool Equals(SpecificMeasure<Q> other)
		{
		...
		public override bool Equals(object obj)
		{
			...
			if (obj.GetType() != typeof(SpecificMeasure<Q>)) return false;
			return Equals((SpecificMeasure<Q>)obj);
		}
		...
		public static SpecificMeasure<Q> operator +(SpecificMeasure<Q> iLhs,  SpecificMeasure<Q> iRhs)
		{
			return new SpecificMeasure<Q>(iLhs.mAmount + iRhs.GetAmount(iLhs.mUnit), iLhs.mUnit);
		}
		...
		public static SpecificMeasure<Q> operator +(IMeasure<Q> iLhs, SpecificMeasure<Q> iRhs)
		{
			return new SpecificMeasure<Q>(iLhs.Amount + iRhs.GetAmount(iLhs.Unit), iLhs.Unit);
		}
		...
		public static SpecificMeasure<Q> operator *(AmountType iScalar, SpecificMeasure<Q> iMeasure)
		{
			return new SpecificMeasure<Q>(iScalar * iMeasure.mAmount, iMeasure.mUnit);
		}
		...
		public static SpecificMeasure<Q> operator *(SpecificMeasure<Q> iMeasure, AmountType iScalar)
		{
			return new SpecificMeasure<Q>(iMeasure.mAmount * iScalar, iMeasure.mUnit);
		}
		...
		public static bool operator <(SpecificMeasure<Q> iLhs, SpecificMeasure<Q> iRhs)
		{
		...
		/// <returns>true if first measure object is less than second measure object; false otherwise</returns>
		public static bool operator <(SpecificMeasure<Q> iLhs, IMeasure<Q> iRhs)
		{
			return iLhs.mAmount < iRhs.GetAmount(iLhs.mUnit);
		}
		...
		/// <param name="iRhs">Second object</param>
		/// <returns>true if first measure object is less than second measure object; false otherwise</returns>
		public static bool operator <(IMeasure<Q> iLhs, SpecificMeasure<Q> iRhs)
		{
