...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Time : IQuantity<Time>, IMeasure<Time>, 
        IMeasureFactory<Time>, IEquatable<Time>, IComparable<Time>
    {
        #region FIELDS

        private static readonly IMeasureFactory<Time> factory = new Time();
        ...
        Time IMeasureFactory<Time>.Create(IMeasure<Time> measure)
        {
        ...
        public Time Create(double amount)
        {
        ...
        public Time Create(double amount, IUnit<Time> unit)
        {
        ...
        /// <param name="amount">Amount.</param>
        /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
        public Time Create(float amount)
        {
            return new Time(amount);
        }
        ...
        /// <param name="unit">Unit.</param>
        /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
        public Time Create(float amount, IUnit<Time> unit)
        {
            return new Time(amount, unit);
        }
        ...
        /// <param name="amount">Amount.</param>
        /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
        public Time Create(decimal amount)
        {
            return new Time(amount);
        }
        ...
        /// <param name="unit">Unit.</param>
        /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
        public Time Create(decimal amount, IUnit<Time> unit)
        {
            return new Time(amount, unit);
        }
        ...
        public IMeasure<Time> this[IUnit<Time> unit]
        {
            get
            {
                ...
                return unit.IsStandardUnit
                    ? (IMeasure<Time>)this
                    : new InUnitMeasure<Time>(this.GetAmount(unit), unit);
            }
        }
        ...
        public static Time operator *(IMeasure<Number> scalar, Time measure)
        {
            return new Time(scalar.StandardAmount * measure.amount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(IMeasure<Time> dividend, Time divisor)
        {
