...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Time : IQuantity<Time>, IMeasure<Time>, IEquatable<Time>, IComparable<Time>
    {
        ...
        private static readonly IMeasureFactory<Time> factory = new MeasureFactory();

        // ReSharper disable once InconsistentNaming
        private static readonly QuantityDimension dimension = new QuantityDimension(0, 0, 1, 0, 0, 0, 0);

        public static readonly Unit<Time> Second = new ConstantConverterUnit<Time>("s");

        public static readonly Unit<Time> Minute = new ConstantConverterUnit<Time>("min", Factors.SecondsPerMinute);
        public static readonly Unit<Time> Hour = new ConstantConverterUnit<Time>("h", Factors.SecondsPerHour);
        public static readonly Unit<Time> Day = new ConstantConverterUnit<Time>("dy", Factors.SecondsPerDay);
        public static readonly Unit<Time> Week = new ConstantConverterUnit<Time>("wk", Factors.SecondsPerWeek);
        public static readonly Unit<Time> JulianYear = new ConstantConverterUnit<Time>("a", Factors.SecondsPerJulianYear);
        ...
        /// </summary>
        IMeasureFactory<Time> IQuantity<Time>.Factory
        { 
            get { return factory; }
        }
        ...
        {
            return this.GetAmount(unit as IUnit<Time>);
        }
        ...
        {
            return this.Equals(other as IMeasure<Time>);
        }
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public Measure<Time> this[IUnit<Time> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new Measure<Time>(this.GetAmount(unit), unit);
            }
        }
        ...
        {
            return obj is IMeasure<Time> && this.Equals((IMeasure<Time>)obj);
        }
        ...
        public static Time operator *(double scalar, Time measure)
        {
            return new Time((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static Time operator *(float scalar, Time measure)
        {
            return new Time((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static Time operator *(decimal scalar, Time measure)
        {
            return new Time((AmountType)scalar * measure.amount);
        }
        ...
        public static Time operator *(Time measure, double scalar)
        {
            return new Time(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static Time operator *(Time measure, float scalar)
        {
            return new Time(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static Time operator *(Time measure, decimal scalar)
        {
            return new Time(measure.amount * (AmountType)scalar);
        }
        ...
        public static Time operator *(Time measure, IMeasure<Number> scalar)
        {
            return new Time(measure.amount * scalar.StandardAmount);
        }
        ...
        public static Number operator /(Time dividend, Time divisor)
        {
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(Time dividend, IMeasure<Time> divisor)
        {
        ...
        #region Private class implementation of IMeasureFactory<Time>
        ...
        private class MeasureFactory : IMeasureFactory<Time>
        {
            ...
            /// <param name="amount">Amount.</param>
            /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
            public Time New(decimal amount)
            {
                return new Time(amount);
            }
