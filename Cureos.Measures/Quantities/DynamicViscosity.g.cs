...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct DynamicViscosity : IQuantity<DynamicViscosity>, IMeasure<DynamicViscosity>, IEquatable<DynamicViscosity>, IComparable<DynamicViscosity>
    {
        ...
        private static readonly IMeasureFactory<DynamicViscosity> factory = new MeasureFactory();
        ...
        /// </summary>
        IMeasureFactory<DynamicViscosity> IQuantity<DynamicViscosity>.Factory
        { 
            get { return factory; }
        }
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public Measure<DynamicViscosity> this[IUnit<DynamicViscosity> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new Measure<DynamicViscosity>(this.GetAmount(unit), unit);
            }
        }
        ...
        public static DynamicViscosity operator *(double scalar, DynamicViscosity measure)
        {
            return new DynamicViscosity((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static DynamicViscosity operator *(float scalar, DynamicViscosity measure)
        {
            return new DynamicViscosity((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static DynamicViscosity operator *(decimal scalar, DynamicViscosity measure)
        {
            return new DynamicViscosity((AmountType)scalar * measure.amount);
        }
        ...
        public static DynamicViscosity operator *(DynamicViscosity measure, double scalar)
        {
            return new DynamicViscosity(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static DynamicViscosity operator *(DynamicViscosity measure, float scalar)
        {
            return new DynamicViscosity(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static DynamicViscosity operator *(DynamicViscosity measure, decimal scalar)
        {
            return new DynamicViscosity(measure.amount * (AmountType)scalar);
        }
        ...
        #region Private class implementation of IMeasureFactory<DynamicViscosity>

        private class MeasureFactory : IMeasureFactory<DynamicViscosity>
        {
            /// <summary>
            ...
            public IMeasure<DynamicViscosity> NewPreserveUnit(double amount, IUnit<DynamicViscosity> unit)
            {
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<DynamicViscosity> NewPreserveUnit(float amount, IUnit<DynamicViscosity> unit)
            {
                return new Measure<DynamicViscosity>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<DynamicViscosity> NewPreserveUnit(decimal amount, IUnit<DynamicViscosity> unit)
            {
                return new Measure<DynamicViscosity>(amount, unit);
            }
        }
