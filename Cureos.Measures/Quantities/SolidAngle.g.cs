...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct SolidAngle : IQuantity<SolidAngle>, IMeasure<SolidAngle>, IEquatable<SolidAngle>, IComparable<SolidAngle>
    {
        ...
        /// </summary>
        IMeasureFactory<SolidAngle> IQuantity<SolidAngle>.Factory
        { 
            get { return factory; }
        }
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public Measure<SolidAngle> this[IUnit<SolidAngle> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new Measure<SolidAngle>(this.GetAmount(unit), unit);
            }
        }
        ...
        public static SolidAngle operator *(double scalar, SolidAngle measure)
        {
            return new SolidAngle((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static SolidAngle operator *(float scalar, SolidAngle measure)
        {
            return new SolidAngle((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static SolidAngle operator *(decimal scalar, SolidAngle measure)
        {
            return new SolidAngle((AmountType)scalar * measure.amount);
        }
        ...
        public static SolidAngle operator *(SolidAngle measure, double scalar)
        {
            return new SolidAngle(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static SolidAngle operator *(SolidAngle measure, float scalar)
        {
            return new SolidAngle(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static SolidAngle operator *(SolidAngle measure, decimal scalar)
        {
            return new SolidAngle(measure.amount * (AmountType)scalar);
        }
        ...
        public static SolidAngle operator *(SolidAngle measure, IMeasure<Number> scalar)
        {
            return new SolidAngle(measure.amount * scalar.StandardAmount);
        }
        ...
        public static Number operator /(SolidAngle dividend, SolidAngle divisor)
        {
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(SolidAngle dividend, IMeasure<SolidAngle> divisor)
        {
        ...
        private class MeasureFactory : IMeasureFactory<SolidAngle>
        {
            ...
            public IMeasure<SolidAngle> NewPreserveUnit(double amount, IUnit<SolidAngle> unit)
            {
                return new Measure<SolidAngle>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<SolidAngle> NewPreserveUnit(float amount, IUnit<SolidAngle> unit)
            {
                return new Measure<SolidAngle>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<SolidAngle> NewPreserveUnit(decimal amount, IUnit<SolidAngle> unit)
            {
                return new Measure<SolidAngle>(amount, unit);
            }
        }
