...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Mass : IQuantity<Mass>, IMeasure<Mass>
    {
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the mass quantity</typeparam>
        /// </summary
        ...
        public bool Equals(IMeasure<Mass> other)
        {
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<Mass> other)
        {
            if (other == null) throw new ArgumentNullException("other");
