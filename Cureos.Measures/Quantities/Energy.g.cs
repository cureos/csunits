...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Energy : IQuantity<Energy>, IMeasure<Energy>
    {
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(Energy))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<Energy> this[IUnit<Energy> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<Energy>(this.GetAmount(unit), unit);
            }
        }
        ...
        {
            return String.Format("{0} {1} (energy)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (energy)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (energy)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (energy)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
