...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Power : IQuantity<Power>, IMeasure<Power>
    {
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the power quantity</typeparam>
        /// </summary
        ...
        public bool Equals(IMeasure<Power> other)
        {
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<Power> other)
        {
            if (other == null) throw new ArgumentNullException("other");
