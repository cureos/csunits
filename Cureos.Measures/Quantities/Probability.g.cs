...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Probability : IQuantity<Probability>, IMeasure<Probability>
    {
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the probability quantity</typeparam>
        /// </summary
        ...
        public bool Equals(IMeasure<Probability> other)
        {
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<Probability> other)
        {
            if (other == null) throw new ArgumentNullException("other");
