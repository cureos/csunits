...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct AmountOfSubstance : IQuantity<AmountOfSubstance>, IMeasure<AmountOfSubstance>, 
        IMeasureFactory<AmountOfSubstance>, IEquatable<AmountOfSubstance>, IComparable<AmountOfSubstance>
    {
        #region FIELDS

        private static readonly IMeasureFactory<AmountOfSubstance> factory = new AmountOfSubstance();
        ...
        /// </summary>
        public IMeasureFactory<AmountOfSubstance> Factory
        { 
            get { return factory; }
        }
        ...
        AmountOfSubstance IMeasureFactory<AmountOfSubstance>.Create(IMeasure<AmountOfSubstance> measure)
        {
            return new AmountOfSubstance(measure.StandardAmount);
        }
        ...
        public AmountOfSubstance Create(double amount)
        {
        ...
        public AmountOfSubstance Create(double amount, IUnit<AmountOfSubstance> unit)
        {
        ...
        /// <param name="amount">Amount.</param>
        /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
        public AmountOfSubstance Create(float amount)
        {
            return new AmountOfSubstance(amount);
        }
        ...
        /// <param name="unit">Unit.</param>
        /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
        public AmountOfSubstance Create(float amount, IUnit<AmountOfSubstance> unit)
        {
            return new AmountOfSubstance(amount, unit);
        }
        ...
        /// <param name="amount">Amount.</param>
        /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
        public AmountOfSubstance Create(decimal amount)
        {
            return new AmountOfSubstance(amount);
        }
        ...
        /// <param name="unit">Unit.</param>
        /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
        public AmountOfSubstance Create(decimal amount, IUnit<AmountOfSubstance> unit)
        {
            return new AmountOfSubstance(amount, unit);
        }
        ...
        public static AmountOfSubstance operator *(IMeasure<Number> scalar, AmountOfSubstance measure)
        {
            return new AmountOfSubstance(scalar.StandardAmount * measure.amount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(IMeasure<AmountOfSubstance> dividend, AmountOfSubstance divisor)
        {
