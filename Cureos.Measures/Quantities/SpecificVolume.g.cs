...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct SpecificVolume : IQuantity<SpecificVolume>, IMeasure<SpecificVolume>, IEquatable<SpecificVolume>, IComparable<SpecificVolume>
    {
        ...
        public static readonly IUnit<SpecificVolume> CubicMeterPerKiloGram = new Unit<SpecificVolume>("m³ kg\u207b¹");
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!(unit.Quantity is SpecificVolume)) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!(other.Unit.Quantity is SpecificVolume)) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        public IMeasure<SpecificVolume> this[IUnit<SpecificVolume> unit]
        {
            get
            {
                ...
                return unit.IsStandardUnit
                    ...
                    : new UnitPreservingMeasure<SpecificVolume>(this.GetAmount(unit), unit);
            }
        }
