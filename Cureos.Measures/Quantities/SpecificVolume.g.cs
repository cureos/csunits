...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct SpecificVolume : IQuantity<SpecificVolume>, IMeasure<SpecificVolume>, IEquatable<SpecificVolume>, IComparable<SpecificVolume>
    {
        ...
        /// </summary>
        IMeasureFactory<SpecificVolume> IQuantity<SpecificVolume>.Factory
        { 
            get { return factory; }
        }
        ...
        public static SpecificVolume operator *(double scalar, SpecificVolume measure)
        {
            return new SpecificVolume((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static SpecificVolume operator *(float scalar, SpecificVolume measure)
        {
            return new SpecificVolume((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static SpecificVolume operator *(decimal scalar, SpecificVolume measure)
        {
            return new SpecificVolume((AmountType)scalar * measure.amount);
        }
        ...
        public static SpecificVolume operator *(SpecificVolume measure, double scalar)
        {
            return new SpecificVolume(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static SpecificVolume operator *(SpecificVolume measure, float scalar)
        {
            return new SpecificVolume(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static SpecificVolume operator *(SpecificVolume measure, decimal scalar)
        {
            return new SpecificVolume(measure.amount * (AmountType)scalar);
        }
