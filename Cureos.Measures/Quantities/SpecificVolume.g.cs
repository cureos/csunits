...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct SpecificVolume : IQuantity<SpecificVolume>, IMeasure<SpecificVolume>
    {
        ...
        /// <summary>
        /// Initializes a SpecificVolume object from an object implementing the IMeasure&lt;SpecificVolume&gt; interface
        /// </summary>
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the specific volume quantity</typeparam>
        /// </summary
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(SpecificVolume))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        public bool Equals(IMeasure<SpecificVolume> other)
        {
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(SpecificVolume))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<SpecificVolume> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<SpecificVolume> this[IUnit<SpecificVolume> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<SpecificVolume>(this.GetAmount(unit), unit);
            }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof(IMeasure<SpecificVolume>)) return false;
            return this.Equals((IMeasure<SpecificVolume>)obj);
        }
        ...
        {
            return String.Format("{0} {1} (specific volume)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (specific volume)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (specific volume)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (specific volume)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
