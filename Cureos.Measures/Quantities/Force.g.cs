...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Force : IQuantity<Force>, IMeasure<Force>, 
        IMeasureFactory<Force>, IEquatable<Force>, IComparable<Force>
    {
        #region FIELDS

        private static readonly IMeasureFactory<Force> factory = new Force();
        ...
        /// </summary>
        public IMeasureFactory<Force> Factory
        { 
            get { return factory; }
        }
        ...
        Force IMeasureFactory<Force>.Create(IMeasure<Force> measure)
        {
        ...
        public Force Create(double amount)
        {
        ...
        public Force Create(double amount, IUnit<Force> unit)
        {
        ...
        /// <param name="amount">Amount.</param>
        /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
        public Force Create(float amount)
        {
            return new Force(amount);
        }
        ...
        /// <param name="unit">Unit.</param>
        /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
        public Force Create(float amount, IUnit<Force> unit)
        {
            return new Force(amount, unit);
        }
        ...
        /// <param name="amount">Amount.</param>
        /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
        public Force Create(decimal amount)
        {
            return new Force(amount);
        }
        ...
        /// <param name="unit">Unit.</param>
        /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
        public Force Create(decimal amount, IUnit<Force> unit)
        {
            return new Force(amount, unit);
        }
        ...
        public static Force operator *(IMeasure<Number> scalar, Force measure)
        {
            return new Force(scalar.StandardAmount * measure.amount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(IMeasure<Force> dividend, Force divisor)
        {
