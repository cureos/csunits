...
namespace Cureos.Measures.Quantities
{
    ...
    /// </summary>
    [DataContract]
    public partial struct Force : IQuantity<Force>, IMeasure<Force>
    {
        #region FIELDS
        ...
        public static readonly Unit<Force> CentiNewton = new Unit<Force>(UnitPrefix.Centi);
        public static readonly Unit<Force> DeciNewton = new Unit<Force>(UnitPrefix.Deci);
        public static readonly Unit<Force> DekaNewton = new Unit<Force>(UnitPrefix.Deka);
        public static readonly Unit<Force> HectoNewton = new Unit<Force>(UnitPrefix.Hecto);
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the force quantity</typeparam>
        /// </summary
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(Force))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        public bool Equals(IMeasure<Force> other)
        {
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(Force))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<Force> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<Force> this[IUnit<Force> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<Force>(this.GetAmount(unit), unit);
            }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof(IMeasure<Force>)) return false;
            return this.Equals((IMeasure<Force>)obj);
        }
        ...
        {
            return String.Format("{0} {1} (force)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (force)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (force)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (force)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
