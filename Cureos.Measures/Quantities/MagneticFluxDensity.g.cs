...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct MagneticFluxDensity : IQuantity<MagneticFluxDensity>, IMeasure<MagneticFluxDensity>, IEquatable<MagneticFluxDensity>, IComparable<MagneticFluxDensity>
    {
        ...
        /// </summary>
        IMeasureFactory<MagneticFluxDensity> IQuantity<MagneticFluxDensity>.Factory
        { 
            get { return factory; }
        }
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public Measure<MagneticFluxDensity> this[IUnit<MagneticFluxDensity> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new Measure<MagneticFluxDensity>(this.GetAmount(unit), unit);
            }
        }
        ...
        public static MagneticFluxDensity operator *(double scalar, MagneticFluxDensity measure)
        {
            return new MagneticFluxDensity((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static MagneticFluxDensity operator *(float scalar, MagneticFluxDensity measure)
        {
            return new MagneticFluxDensity((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static MagneticFluxDensity operator *(decimal scalar, MagneticFluxDensity measure)
        {
            return new MagneticFluxDensity((AmountType)scalar * measure.amount);
        }
        ...
        public static MagneticFluxDensity operator *(MagneticFluxDensity measure, double scalar)
        {
            return new MagneticFluxDensity(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static MagneticFluxDensity operator *(MagneticFluxDensity measure, float scalar)
        {
            return new MagneticFluxDensity(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static MagneticFluxDensity operator *(MagneticFluxDensity measure, decimal scalar)
        {
            return new MagneticFluxDensity(measure.amount * (AmountType)scalar);
        }
        ...
        private class MeasureFactory : IMeasureFactory<MagneticFluxDensity>
        {
            ...
            public IMeasure<MagneticFluxDensity> NewPreserveUnit(double amount, IUnit<MagneticFluxDensity> unit)
            {
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<MagneticFluxDensity> NewPreserveUnit(float amount, IUnit<MagneticFluxDensity> unit)
            {
                return new Measure<MagneticFluxDensity>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<MagneticFluxDensity> NewPreserveUnit(decimal amount, IUnit<MagneticFluxDensity> unit)
            {
                return new Measure<MagneticFluxDensity>(amount, unit);
            }
        }
