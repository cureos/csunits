...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct MagneticFluxDensity : IQuantity<MagneticFluxDensity>, IMeasure<MagneticFluxDensity>
    {
        ...
        public static readonly Unit<MagneticFluxDensity> CentiTesla = new Unit<MagneticFluxDensity>(UnitPrefix.Centi);
        public static readonly Unit<MagneticFluxDensity> DeciTesla = new Unit<MagneticFluxDensity>(UnitPrefix.Deci);
        public static readonly Unit<MagneticFluxDensity> DekaTesla = new Unit<MagneticFluxDensity>(UnitPrefix.Deka);
        public static readonly Unit<MagneticFluxDensity> HectoTesla = new Unit<MagneticFluxDensity>(UnitPrefix.Hecto);
        ...
        /// <summary>
        /// Initializes a MagneticFluxDensity object from an object implementing the IMeasure&lt;MagneticFluxDensity&gt; interface
        /// </summary>
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the magnetic flux density quantity</typeparam>
        /// </summary
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(MagneticFluxDensity))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        public bool Equals(IMeasure<MagneticFluxDensity> other)
        {
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(MagneticFluxDensity))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<MagneticFluxDensity> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<MagneticFluxDensity> this[IUnit<MagneticFluxDensity> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<MagneticFluxDensity>(this.GetAmount(unit), unit);
            }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof(IMeasure<MagneticFluxDensity>)) return false;
            return this.Equals((IMeasure<MagneticFluxDensity>)obj);
        }
        ...
        {
            return String.Format("{0} {1} (magnetic flux density)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (magnetic flux density)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (magnetic flux density)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (magnetic flux density)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
