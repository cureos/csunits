...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct CatalyticActivity : IQuantity<CatalyticActivity>, IMeasure<CatalyticActivity>
    {
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<CatalyticActivity> this[IUnit<CatalyticActivity> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<CatalyticActivity>(this.GetAmount(unit), unit);
            }
        }
