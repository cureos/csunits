...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct CatalyticActivity : IQuantity<CatalyticActivity>, IMeasure<CatalyticActivity>, IEquatable<CatalyticActivity>, IComparable<CatalyticActivity>
    {
        ...
        /// </summary>
        IMeasureFactory<CatalyticActivity> IQuantity<CatalyticActivity>.Factory
        { 
            get { return factory; }
        }
        ...
        public static CatalyticActivity operator *(double scalar, CatalyticActivity measure)
        {
            return new CatalyticActivity((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static CatalyticActivity operator *(float scalar, CatalyticActivity measure)
        {
            return new CatalyticActivity((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static CatalyticActivity operator *(decimal scalar, CatalyticActivity measure)
        {
            return new CatalyticActivity((AmountType)scalar * measure.amount);
        }
        ...
        public static CatalyticActivity operator *(CatalyticActivity measure, double scalar)
        {
            return new CatalyticActivity(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static CatalyticActivity operator *(CatalyticActivity measure, float scalar)
        {
            return new CatalyticActivity(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static CatalyticActivity operator *(CatalyticActivity measure, decimal scalar)
        {
            return new CatalyticActivity(measure.amount * (AmountType)scalar);
        }
        ...
        private class MeasureFactory : IMeasureFactory<CatalyticActivity>
        {
            ...
            public IMeasure<CatalyticActivity> NewPreserveUnit(double amount, IUnit<CatalyticActivity> unit)
            {
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<CatalyticActivity> NewPreserveUnit(float amount, IUnit<CatalyticActivity> unit)
            {
                return new Measure<CatalyticActivity>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<CatalyticActivity> NewPreserveUnit(decimal amount, IUnit<CatalyticActivity> unit)
            {
                return new Measure<CatalyticActivity>(amount, unit);
            }
        }
