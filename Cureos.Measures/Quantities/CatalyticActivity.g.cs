...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct CatalyticActivity : IQuantity<CatalyticActivity>, IMeasure<CatalyticActivity>, IEquatable<CatalyticActivity>, IComparable<CatalyticActivity>
    {
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!(unit.Quantity is CatalyticActivity)) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!(other.Unit.Quantity is CatalyticActivity)) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        public IMeasure<CatalyticActivity> this[IUnit<CatalyticActivity> unit]
        {
            get
            {
                ...
                return unit.IsStandardUnit
                    ...
                    : new UnitPreservingMeasure<CatalyticActivity>(this.GetAmount(unit), unit);
            }
        }
