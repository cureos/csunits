...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct HeatFluxDensity : IQuantity<HeatFluxDensity>, IMeasure<HeatFluxDensity>, IEquatable<HeatFluxDensity>, IComparable<HeatFluxDensity>
    {
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!(unit.Quantity is HeatFluxDensity)) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!(other.Unit.Quantity is HeatFluxDensity)) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        public IMeasure<HeatFluxDensity> this[IUnit<HeatFluxDensity> unit]
        {
            get
            {
                ...
                return unit.IsStandardUnit
                    ...
                    : new UnitPreservingMeasure<HeatFluxDensity>(this.GetAmount(unit), unit);
            }
        }
