...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct MagneticFlux : IQuantity<MagneticFlux>, IMeasure<MagneticFlux>, IEquatable<MagneticFlux>, IComparable<MagneticFlux>
    {
        ...
        public static readonly IUnit<MagneticFlux> Weber = new ConstantConverterUnit<MagneticFlux>("Wb");

        public static readonly IUnit<MagneticFlux> NanoWeber = new ConstantConverterUnit<MagneticFlux>(UnitPrefix.Nano);
        public static readonly IUnit<MagneticFlux> MicroWeber = new ConstantConverterUnit<MagneticFlux>(UnitPrefix.Micro);
        public static readonly IUnit<MagneticFlux> MilliWeber = new ConstantConverterUnit<MagneticFlux>(UnitPrefix.Milli);
        public static readonly IUnit<MagneticFlux> CentiWeber = new ConstantConverterUnit<MagneticFlux>(UnitPrefix.Centi);
        public static readonly IUnit<MagneticFlux> DeciWeber = new ConstantConverterUnit<MagneticFlux>(UnitPrefix.Deci);
        public static readonly IUnit<MagneticFlux> DekaWeber = new ConstantConverterUnit<MagneticFlux>(UnitPrefix.Deka);
        public static readonly IUnit<MagneticFlux> HectoWeber = new ConstantConverterUnit<MagneticFlux>(UnitPrefix.Hecto);
        public static readonly IUnit<MagneticFlux> KiloWeber = new ConstantConverterUnit<MagneticFlux>(UnitPrefix.Kilo);
        public static readonly IUnit<MagneticFlux> MegaWeber = new ConstantConverterUnit<MagneticFlux>(UnitPrefix.Mega);
        public static readonly IUnit<MagneticFlux> GigaWeber = new ConstantConverterUnit<MagneticFlux>(UnitPrefix.Giga);
