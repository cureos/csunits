...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct MagneticFlux : IQuantity<MagneticFlux>, IMeasure<MagneticFlux>, IEquatable<MagneticFlux>, IComparable<MagneticFlux>
    {
        ...
        private static readonly IMeasureFactory<MagneticFlux> factory = new MeasureFactory();
        ...
        /// </summary>
        IMeasureFactory<MagneticFlux> IQuantity<MagneticFlux>.Factory
        { 
            get { return factory; }
        }
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public Measure<MagneticFlux> this[IUnit<MagneticFlux> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new Measure<MagneticFlux>(this.GetAmount(unit), unit);
            }
        }
        ...
        public static MagneticFlux operator *(double scalar, MagneticFlux measure)
        {
            return new MagneticFlux((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static MagneticFlux operator *(float scalar, MagneticFlux measure)
        {
            return new MagneticFlux((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static MagneticFlux operator *(decimal scalar, MagneticFlux measure)
        {
            return new MagneticFlux((AmountType)scalar * measure.amount);
        }
        ...
        public static MagneticFlux operator *(MagneticFlux measure, double scalar)
        {
            return new MagneticFlux(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static MagneticFlux operator *(MagneticFlux measure, float scalar)
        {
            return new MagneticFlux(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static MagneticFlux operator *(MagneticFlux measure, decimal scalar)
        {
            return new MagneticFlux(measure.amount * (AmountType)scalar);
        }
        ...
        public static MagneticFlux operator *(MagneticFlux measure, IMeasure<Number> scalar)
        {
            return new MagneticFlux(measure.amount * scalar.StandardAmount);
        }
        ...
        public static Number operator /(MagneticFlux dividend, MagneticFlux divisor)
        {
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(MagneticFlux dividend, IMeasure<MagneticFlux> divisor)
        {
        ...
        #region Private class implementation of IMeasureFactory<MagneticFlux>

        private class MeasureFactory : IMeasureFactory<MagneticFlux>
        {
            /// <summary>
            ...
            public MagneticFlux New(double amount)
            {
                return new MagneticFlux(amount);
            }
            ...
            /// <param name="amount">Amount.</param>
            /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
            public MagneticFlux New(float amount)
            {
                return new MagneticFlux(amount);
            }
            ...
            /// <param name="amount">Amount.</param>
            /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
            public MagneticFlux New(decimal amount)
            {
                return new MagneticFlux(amount);
            }
            ...
            public IMeasure<MagneticFlux> NewPreserveUnit(double amount, IUnit<MagneticFlux> unit)
            {
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<MagneticFlux> NewPreserveUnit(float amount, IUnit<MagneticFlux> unit)
            {
                return new Measure<MagneticFlux>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<MagneticFlux> NewPreserveUnit(decimal amount, IUnit<MagneticFlux> unit)
            {
                return new Measure<MagneticFlux>(amount, unit);
            }
        }
