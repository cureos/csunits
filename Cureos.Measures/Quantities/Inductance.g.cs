...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Inductance : IQuantity<Inductance>, IMeasure<Inductance>
    {
        ...
        public static readonly Unit<Inductance> CentiHenry = new Unit<Inductance>(UnitPrefix.Centi);
        public static readonly Unit<Inductance> DeciHenry = new Unit<Inductance>(UnitPrefix.Deci);
        public static readonly Unit<Inductance> DekaHenry = new Unit<Inductance>(UnitPrefix.Deka);
        public static readonly Unit<Inductance> HectoHenry = new Unit<Inductance>(UnitPrefix.Hecto);
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the inductance quantity</typeparam>
        /// </summary
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(Inductance))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        public bool Equals(IMeasure<Inductance> other)
        {
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(Inductance))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<Inductance> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<Inductance> this[IUnit<Inductance> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<Inductance>(this.GetAmount(unit), unit);
            }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof(IMeasure<Inductance>)) return false;
            return this.Equals((IMeasure<Inductance>)obj);
        }
        ...
        {
            return String.Format("{0} {1} (inductance)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (inductance)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (inductance)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (inductance)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
