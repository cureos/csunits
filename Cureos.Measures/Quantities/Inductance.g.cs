...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Inductance : IQuantity<Inductance>, IMeasure<Inductance>, IEquatable<Inductance>, IComparable<Inductance>
    {
        ...
        private static readonly IMeasureFactory<Inductance> factory = new MeasureFactory();

        // ReSharper disable once InconsistentNaming
        private static readonly QuantityDimension dimension = new QuantityDimension(2, 1, -2, -2, 0, 0, 0);

        public static readonly Unit<Inductance> Henry = new ConstantConverterUnit<Inductance>("H");

        public static readonly Unit<Inductance> NanoHenry = new ConstantConverterUnit<Inductance>(UnitPrefix.Nano);
        public static readonly Unit<Inductance> MicroHenry = new ConstantConverterUnit<Inductance>(UnitPrefix.Micro);
        public static readonly Unit<Inductance> MilliHenry = new ConstantConverterUnit<Inductance>(UnitPrefix.Milli);
        public static readonly Unit<Inductance> CentiHenry = new ConstantConverterUnit<Inductance>(UnitPrefix.Centi);
        public static readonly Unit<Inductance> DeciHenry = new ConstantConverterUnit<Inductance>(UnitPrefix.Deci);
        public static readonly Unit<Inductance> DekaHenry = new ConstantConverterUnit<Inductance>(UnitPrefix.Deka);
        public static readonly Unit<Inductance> HectoHenry = new ConstantConverterUnit<Inductance>(UnitPrefix.Hecto);
        public static readonly Unit<Inductance> KiloHenry = new ConstantConverterUnit<Inductance>(UnitPrefix.Kilo);
        public static readonly Unit<Inductance> MegaHenry = new ConstantConverterUnit<Inductance>(UnitPrefix.Mega);
        public static readonly Unit<Inductance> GigaHenry = new ConstantConverterUnit<Inductance>(UnitPrefix.Giga);
        ...
        /// </summary>
        IMeasureFactory<Inductance> IQuantity<Inductance>.Factory
        { 
            get { return factory; }
        }
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public Measure<Inductance> this[IUnit<Inductance> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new Measure<Inductance>(this.GetAmount(unit), unit);
            }
        }
        ...
        public static Inductance operator *(double scalar, Inductance measure)
        {
            return new Inductance((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static Inductance operator *(float scalar, Inductance measure)
        {
            return new Inductance((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static Inductance operator *(decimal scalar, Inductance measure)
        {
            return new Inductance((AmountType)scalar * measure.amount);
        }
        ...
        public static Inductance operator *(Inductance measure, double scalar)
        {
            return new Inductance(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static Inductance operator *(Inductance measure, float scalar)
        {
            return new Inductance(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static Inductance operator *(Inductance measure, decimal scalar)
        {
            return new Inductance(measure.amount * (AmountType)scalar);
        }
        ...
        public static Inductance operator *(Inductance measure, IMeasure<Number> scalar)
        {
            return new Inductance(measure.amount * scalar.StandardAmount);
        }
        ...
        public static Number operator /(Inductance dividend, Inductance divisor)
        {
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(Inductance dividend, IMeasure<Inductance> divisor)
        {
        ...
        #region Private class implementation of IMeasureFactory<Inductance>

        private class MeasureFactory : IMeasureFactory<Inductance>
        {
            /// <summary>
            ...
            public IMeasure<Inductance> NewPreserveUnit(double amount, IUnit<Inductance> unit)
            {
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<Inductance> NewPreserveUnit(float amount, IUnit<Inductance> unit)
            {
                return new Measure<Inductance>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<Inductance> NewPreserveUnit(decimal amount, IUnit<Inductance> unit)
            {
                return new Measure<Inductance>(amount, unit);
            }
        }
