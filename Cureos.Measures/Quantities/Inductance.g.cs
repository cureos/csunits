...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Inductance : IQuantity<Inductance>, IMeasure<Inductance>, IEquatable<Inductance>, IComparable<Inductance>
    {
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!(unit.Quantity is Inductance)) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!(other.Unit.Quantity is Inductance)) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
