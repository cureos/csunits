...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct AbsorbedDose : IQuantity<AbsorbedDose>, IMeasure<AbsorbedDose>, IEquatable<AbsorbedDose>, IComparable<AbsorbedDose>
    {
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!(unit.Quantity is AbsorbedDose)) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!(other.Unit.Quantity is AbsorbedDose)) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
