...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct AbsorbedDose : IQuantity<AbsorbedDose>, IMeasure<AbsorbedDose>, IMeasureFactory<AbsorbedDose>, IEquatable<AbsorbedDose>, IComparable<AbsorbedDose>
    {
        ...
        public static AbsorbedDose operator *(IMeasure<Number> scalar, AbsorbedDose measure)
        {
            return new AbsorbedDose(scalar.StandardAmount * measure.amount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(IMeasure<AbsorbedDose> dividend, AbsorbedDose divisor)
        {
