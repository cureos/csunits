...
namespace Cureos.Measures.Quantities
{
    ...
    /// </summary>
    [DataContract]
    public partial struct RefractiveIndex : IQuantity<RefractiveIndex>, IMeasure<RefractiveIndex>
    {
        #region FIELDS
        ...
        /// <summary>
        /// Initializes a RefractiveIndex object from an object implementing the IMeasure&lt;RefractiveIndex&gt; interface
        /// </summary>
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the refractive index quantity</typeparam>
        /// </summary
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(RefractiveIndex))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        public bool Equals(IMeasure<RefractiveIndex> other)
        {
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(RefractiveIndex))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<RefractiveIndex> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<RefractiveIndex> this[IUnit<RefractiveIndex> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<RefractiveIndex>(this.GetAmount(unit), unit);
            }
        }
        ...
        {
            return String.Format("{0} {1} (refractive index)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (refractive index)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (refractive index)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (refractive index)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
