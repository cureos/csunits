...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct RefractiveIndex : IQuantity<RefractiveIndex>, IMeasure<RefractiveIndex>, IEquatable<RefractiveIndex>, IComparable<RefractiveIndex>
    {
        ...
        private static readonly IMeasureFactory<RefractiveIndex> factory = new MeasureFactory();
        ...
        /// </summary>
        IMeasureFactory<RefractiveIndex> IQuantity<RefractiveIndex>.Factory
        { 
            get { return factory; }
        }
        ...
        {
            return this.GetAmount(unit as IUnit<RefractiveIndex>);
        }
        ...
        {
            return this.Equals(other as IMeasure<RefractiveIndex>);
        }
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public Measure<RefractiveIndex> this[IUnit<RefractiveIndex> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new Measure<RefractiveIndex>(this.GetAmount(unit), unit);
            }
        }
        ...
        {
            return obj is IMeasure<RefractiveIndex> && this.Equals((IMeasure<RefractiveIndex>)obj);
        }
        ...
        public static RefractiveIndex operator *(RefractiveIndex measure, IMeasure<Number> scalar)
        {
            return new RefractiveIndex(measure.amount * scalar.StandardAmount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(RefractiveIndex dividend, IMeasure<RefractiveIndex> divisor)
        {
        ...
        #region Private class implementation of IMeasureFactory<RefractiveIndex>
