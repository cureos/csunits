...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct RefractiveIndex : IQuantity<RefractiveIndex>, IMeasure<RefractiveIndex>, 
        IMeasureFactory<RefractiveIndex>, IEquatable<RefractiveIndex>, IComparable<RefractiveIndex>
    {
        #region FIELDS

        private static readonly IMeasureFactory<RefractiveIndex> factory = new RefractiveIndex();
