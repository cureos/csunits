...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Acceleration : IQuantity<Acceleration>, IMeasure<Acceleration>, IEquatable<Acceleration>, IComparable<Acceleration>
    {
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!(unit.Quantity is Acceleration)) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!(other.Unit.Quantity is Acceleration)) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
