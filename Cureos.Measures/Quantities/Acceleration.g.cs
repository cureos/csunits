...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Acceleration : IQuantity<Acceleration>, IMeasure<Acceleration>, IEquatable<Acceleration>, IComparable<Acceleration>
    {
        ...
        public static Acceleration operator *(IMeasure<Number> scalar, Acceleration measure)
        {
            return new Acceleration(scalar.StandardAmount * measure.amount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(IMeasure<Acceleration> dividend, Acceleration divisor)
        {
