...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Acceleration : IQuantity<Acceleration>, IMeasure<Acceleration>, IEquatable<Acceleration>, IComparable<Acceleration>
    {
        ...
        private static readonly IMeasureFactory<Acceleration> factory = new MeasureFactory();
        ...
        /// </summary>
        IMeasureFactory<Acceleration> IQuantity<Acceleration>.Factory
        { 
            get { return factory; }
        }
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public Measure<Acceleration> this[IUnit<Acceleration> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new Measure<Acceleration>(this.GetAmount(unit), unit);
            }
        }
        ...
        public static Acceleration operator *(double scalar, Acceleration measure)
        {
            return new Acceleration((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static Acceleration operator *(float scalar, Acceleration measure)
        {
            return new Acceleration((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static Acceleration operator *(decimal scalar, Acceleration measure)
        {
            return new Acceleration((AmountType)scalar * measure.amount);
        }
        ...
        public static Acceleration operator *(Acceleration measure, double scalar)
        {
            return new Acceleration(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static Acceleration operator *(Acceleration measure, float scalar)
        {
            return new Acceleration(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static Acceleration operator *(Acceleration measure, decimal scalar)
        {
            return new Acceleration(measure.amount * (AmountType)scalar);
        }
        ...
        public static Acceleration operator *(Acceleration measure, IMeasure<Number> scalar)
        {
            return new Acceleration(measure.amount * scalar.StandardAmount);
        }
        ...
        public static Number operator /(Acceleration dividend, Acceleration divisor)
        {
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(Acceleration dividend, IMeasure<Acceleration> divisor)
        {
        ...
        #region Private class implementation of IMeasureFactory<Acceleration>

        private class MeasureFactory : IMeasureFactory<Acceleration>
        {
            /// <summary>
            ...
            public Acceleration New(double amount)
            {
                return new Acceleration(amount);
            }
            ...
            /// <param name="amount">Amount.</param>
            /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
            public Acceleration New(float amount)
            {
                return new Acceleration(amount);
            }
            ...
            /// <param name="amount">Amount.</param>
            /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
            public Acceleration New(decimal amount)
            {
                return new Acceleration(amount);
            }
            ...
            public IMeasure<Acceleration> NewPreserveUnit(double amount, IUnit<Acceleration> unit)
            {
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<Acceleration> NewPreserveUnit(float amount, IUnit<Acceleration> unit)
            {
                return new Measure<Acceleration>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<Acceleration> NewPreserveUnit(decimal amount, IUnit<Acceleration> unit)
            {
                return new Measure<Acceleration>(amount, unit);
            }
        }
