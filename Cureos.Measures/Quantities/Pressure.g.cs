...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Pressure : IQuantity<Pressure>, IMeasure<Pressure>, IEquatable<Pressure>, IComparable<Pressure>
    {
        ...
        private static readonly IMeasureFactory<Pressure> factory = new MeasureFactory();
        ...
        /// </summary>
        IMeasureFactory<Pressure> IQuantity<Pressure>.Factory
        { 
            get { return factory; }
        }
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public Measure<Pressure> this[IUnit<Pressure> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new Measure<Pressure>(this.GetAmount(unit), unit);
            }
        }
        ...
        public static Pressure operator *(double scalar, Pressure measure)
        {
            return new Pressure((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static Pressure operator *(float scalar, Pressure measure)
        {
            return new Pressure((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static Pressure operator *(decimal scalar, Pressure measure)
        {
            return new Pressure((AmountType)scalar * measure.amount);
        }
        ...
        public static Pressure operator *(Pressure measure, double scalar)
        {
            return new Pressure(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static Pressure operator *(Pressure measure, float scalar)
        {
            return new Pressure(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static Pressure operator *(Pressure measure, decimal scalar)
        {
            return new Pressure(measure.amount * (AmountType)scalar);
        }
        ...
        public static Pressure operator *(Pressure measure, IMeasure<Number> scalar)
        {
            return new Pressure(measure.amount * scalar.StandardAmount);
        }
        ...
        public static Number operator /(Pressure dividend, Pressure divisor)
        {
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(Pressure dividend, IMeasure<Pressure> divisor)
        {
        ...
        #region Private class implementation of IMeasureFactory<Pressure>
