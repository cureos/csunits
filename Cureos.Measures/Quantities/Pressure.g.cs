...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Pressure : IQuantity<Pressure>, IMeasure<Pressure>, IEquatable<Pressure>, IComparable<Pressure>
    {
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!(unit.Quantity is Pressure)) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!(other.Unit.Quantity is Pressure)) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
