...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Pressure : IQuantity<Pressure>, IMeasure<Pressure>, IEquatable<Pressure>, IComparable<Pressure>
    {
        ...
        public static Pressure operator *(IMeasure<Number> scalar, Pressure measure)
        {
            return new Pressure(scalar.StandardAmount * measure.amount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(IMeasure<Pressure> dividend, Pressure divisor)
        {
