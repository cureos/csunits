...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Luminance : IQuantity<Luminance>, IMeasure<Luminance>, IEquatable<Luminance>, IComparable<Luminance>
    {
        ...
        /// </summary>
        IMeasureFactory<Luminance> IQuantity<Luminance>.Factory
        { 
            get { return factory; }
        }
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public Measure<Luminance> this[IUnit<Luminance> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new Measure<Luminance>(this.GetAmount(unit), unit);
            }
        }
        ...
        public static Luminance operator *(double scalar, Luminance measure)
        {
            return new Luminance((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static Luminance operator *(float scalar, Luminance measure)
        {
            return new Luminance((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static Luminance operator *(decimal scalar, Luminance measure)
        {
            return new Luminance((AmountType)scalar * measure.amount);
        }
        ...
        public static Luminance operator *(Luminance measure, double scalar)
        {
            return new Luminance(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static Luminance operator *(Luminance measure, float scalar)
        {
            return new Luminance(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static Luminance operator *(Luminance measure, decimal scalar)
        {
            return new Luminance(measure.amount * (AmountType)scalar);
        }
        ...
        public static Luminance operator *(Luminance measure, IMeasure<Number> scalar)
        {
            return new Luminance(measure.amount * scalar.StandardAmount);
        }
        ...
        public static Number operator /(Luminance dividend, Luminance divisor)
        {
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(Luminance dividend, IMeasure<Luminance> divisor)
        {
        ...
        private class MeasureFactory : IMeasureFactory<Luminance>
        {
            ...
            public IMeasure<Luminance> NewPreserveUnit(double amount, IUnit<Luminance> unit)
            {
                return new Measure<Luminance>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<Luminance> NewPreserveUnit(float amount, IUnit<Luminance> unit)
            {
                return new Measure<Luminance>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<Luminance> NewPreserveUnit(decimal amount, IUnit<Luminance> unit)
            {
                return new Measure<Luminance>(amount, unit);
            }
        }
