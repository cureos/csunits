...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Temperature : IQuantity<Temperature>, IMeasure<Temperature>, IEquatable<Temperature>, IComparable<Temperature>
    {
        ...
        public static readonly IUnit<Temperature> Kelvin = new ConstantConverterUnit<Temperature>("K");

        public static readonly IUnit<Temperature> Celsius = new FunctionConverterUnit<Temperature>("°C",
                        a => a + Factors.KelvinCelsiusIntercept, a => a - Factors.KelvinCelsiusIntercept);
        public static readonly IUnit<Temperature> Fahrenheit = new FunctionConverterUnit<Temperature>("°F",
