...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Temperature : IQuantity<Temperature>, IMeasure<Temperature>, IEquatable<Temperature>, IComparable<Temperature>
    {
        ...
        private static readonly IMeasureFactory<Temperature> factory = new MeasureFactory();
        ...
        /// </summary>
        IMeasureFactory<Temperature> IQuantity<Temperature>.Factory
        { 
            get { return factory; }
        }
        ...
        {
            return this.GetAmount(unit as IUnit<Temperature>);
        }
        ...
        {
            return this.Equals(other as IMeasure<Temperature>);
        }
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public Measure<Temperature> this[IUnit<Temperature> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new Measure<Temperature>(this.GetAmount(unit), unit);
            }
        }
        ...
        {
            return obj is IMeasure<Temperature> && this.Equals((IMeasure<Temperature>)obj);
        }
        ...
        public static Temperature operator *(double scalar, Temperature measure)
        {
            return new Temperature((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static Temperature operator *(float scalar, Temperature measure)
        {
            return new Temperature((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static Temperature operator *(decimal scalar, Temperature measure)
        {
            return new Temperature((AmountType)scalar * measure.amount);
        }
        ...
        public static Temperature operator *(Temperature measure, double scalar)
        {
            return new Temperature(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static Temperature operator *(Temperature measure, float scalar)
        {
            return new Temperature(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static Temperature operator *(Temperature measure, decimal scalar)
        {
            return new Temperature(measure.amount * (AmountType)scalar);
        }
        ...
        public static Temperature operator *(Temperature measure, IMeasure<Number> scalar)
        {
            return new Temperature(measure.amount * scalar.StandardAmount);
        }
        ...
        public static Number operator /(Temperature dividend, Temperature divisor)
        {
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(Temperature dividend, IMeasure<Temperature> divisor)
        {
        ...
        #region Private class implementation of IMeasureFactory<Temperature>
