...
namespace Cureos.Measures.Quantities
{
    ...
    /// </summary>
    [DataContract]
    public partial struct HeatCapacity : IQuantity<HeatCapacity>, IMeasure<HeatCapacity>
    {
        #region FIELDS
        ...
        /// <summary>
        /// Initializes a HeatCapacity object from an object implementing the IMeasure&lt;HeatCapacity&gt; interface
        /// </summary>
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the heat capacity quantity</typeparam>
        /// </summary
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(HeatCapacity))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        public bool Equals(IMeasure<HeatCapacity> other)
        {
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(HeatCapacity))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<HeatCapacity> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<HeatCapacity> this[IUnit<HeatCapacity> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<HeatCapacity>(this.GetAmount(unit), unit);
            }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof(IMeasure<HeatCapacity>)) return false;
            return this.Equals((IMeasure<HeatCapacity>)obj);
        }
        ...
        {
            return String.Format("{0} {1} (heat capacity)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (heat capacity)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (heat capacity)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (heat capacity)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
