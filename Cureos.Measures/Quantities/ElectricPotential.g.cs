...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct ElectricPotential : IQuantity<ElectricPotential>, IMeasure<ElectricPotential>, 
        IMeasureFactory<ElectricPotential>, IEquatable<ElectricPotential>, IComparable<ElectricPotential>
    {
        #region FIELDS

        private static readonly IMeasureFactory<ElectricPotential> factory = new ElectricPotential();
        ...
        /// </summary>
        public IMeasureFactory<ElectricPotential> Factory
        { 
            get { return factory; }
        }
        ...
        #region Implementation of IMeasureFactory<ElectricPotential>
        ...
        ElectricPotential IMeasureFactory<ElectricPotential>.Create(IMeasure<ElectricPotential> measure)
        {
            return new ElectricPotential(measure.StandardAmount);
        }
        ...
        public ElectricPotential Create(double amount)
        {
        ...
        public ElectricPotential Create(double amount, IUnit<ElectricPotential> unit)
        {
        ...
        /// <param name="amount">Amount.</param>
        /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
        public ElectricPotential Create(float amount)
        {
            return new ElectricPotential(amount);
        }
        ...
        /// <param name="unit">Unit.</param>
        /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
        public ElectricPotential Create(float amount, IUnit<ElectricPotential> unit)
        {
            return new ElectricPotential(amount, unit);
        }
        ...
        /// <param name="amount">Amount.</param>
        /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
        public ElectricPotential Create(decimal amount)
        {
            return new ElectricPotential(amount);
        }
        ...
        /// <param name="unit">Unit.</param>
        /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
        public ElectricPotential Create(decimal amount, IUnit<ElectricPotential> unit)
        {
            return new ElectricPotential(amount, unit);
        }
        ...
        public static ElectricPotential operator *(IMeasure<Number> scalar, ElectricPotential measure)
        {
            return new ElectricPotential(scalar.StandardAmount * measure.amount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(IMeasure<ElectricPotential> dividend, ElectricPotential divisor)
        {
