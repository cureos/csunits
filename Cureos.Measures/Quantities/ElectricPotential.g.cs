...
namespace Cureos.Measures.Quantities
{
    ...
    /// </summary>
    [DataContract]
    public partial struct ElectricPotential : IQuantity<ElectricPotential>, IMeasure<ElectricPotential>
    {
        #region FIELDS
        ...
        public static readonly Unit<ElectricPotential> CentiVolt = new Unit<ElectricPotential>(UnitPrefix.Centi);
        public static readonly Unit<ElectricPotential> DeciVolt = new Unit<ElectricPotential>(UnitPrefix.Deci);
        public static readonly Unit<ElectricPotential> DekaVolt = new Unit<ElectricPotential>(UnitPrefix.Deka);
        public static readonly Unit<ElectricPotential> HectoVolt = new Unit<ElectricPotential>(UnitPrefix.Hecto);
        ...
        /// <summary>
        /// Initializes a ElectricPotential object from an object implementing the IMeasure&lt;ElectricPotential&gt; interface
        /// </summary>
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the electric potential quantity</typeparam>
        /// </summary
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(ElectricPotential))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        public bool Equals(IMeasure<ElectricPotential> other)
        {
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(ElectricPotential))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<ElectricPotential> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<ElectricPotential> this[IUnit<ElectricPotential> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<ElectricPotential>(this.GetAmount(unit), unit);
            }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof(IMeasure<ElectricPotential>)) return false;
            return this.Equals((IMeasure<ElectricPotential>)obj);
        }
        ...
        {
            return String.Format("{0} {1} (electric potential)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (electric potential)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (electric potential)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (electric potential)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
        ...
        public static ElectricPotential operator *(AmountType scalar, ElectricPotential measure)
        {
            return new ElectricPotential(scalar * measure.amount);
        }
        ...
        public static ElectricPotential operator *(ElectricPotential measure, AmountType scalar)
        {
            return new ElectricPotential(measure.amount * scalar);
        }
