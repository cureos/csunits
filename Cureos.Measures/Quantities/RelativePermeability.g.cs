...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct RelativePermeability : IQuantity<RelativePermeability>, IMeasure<RelativePermeability>, IEquatable<RelativePermeability>, IComparable<RelativePermeability>
    {
        ...
        public static readonly IUnit<RelativePermeability> One = new Unit<RelativePermeability>("");
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!(unit.Quantity is RelativePermeability)) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!(other.Unit.Quantity is RelativePermeability)) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public IMeasure<RelativePermeability> this[IUnit<RelativePermeability> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof(IMeasure<RelativePermeability>)) return false;
            return this.Equals((IMeasure<RelativePermeability>)obj);
        }
