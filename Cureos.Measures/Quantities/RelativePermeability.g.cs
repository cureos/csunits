...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct RelativePermeability : IQuantity<RelativePermeability>, IMeasure<RelativePermeability>, IEquatable<RelativePermeability>, IComparable<RelativePermeability>
    {
        ...
        public static RelativePermeability operator *(AmountType scalar, RelativePermeability measure)
        {
            return new RelativePermeability(scalar * measure.amount);
        }
        ...
        public static RelativePermeability operator *(RelativePermeability measure, AmountType scalar)
        {
            return new RelativePermeability(measure.amount * scalar);
        }
        ...
        public static RelativePermeability operator *(IMeasure<Number> scalar, RelativePermeability measure)
        {
            return new RelativePermeability(scalar.StandardAmount * measure.amount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(IMeasure<RelativePermeability> dividend, RelativePermeability divisor)
        {
        ...
        /// <summary>
        /// Less than operator for measure objects, where left-hand side may be any object implementing the IMeasure&lt;RelativePermeability&gt; interface
        /// </summary>
        /// <param name="lhs">First object (any object implementing IMeasure&lt;RelativePermeability&gt; interface)</param>
        /// <param name="rhs">Second object</param>
        /// <returns>true if first measure object is less than second measure object; false otherwise</returns>
        public static bool operator <(IMeasure<RelativePermeability> lhs, RelativePermeability rhs)
        {
        ...
        /// <summary>
        /// Greater than operator for measure objects, where left-hand side may be any object implementing the IMeasure&lt;RelativePermeability&gt; interface
        /// </summary>
        /// <param name="lhs">First object (any object implementing IMeasure&lt;RelativePermeability&gt; interface)</param>
        /// <param name="rhs">Second object</param>
        /// <returns>true if first measure object is greater than second measure object; false otherwise</returns>
        ...
        /// <summary>
        /// Less than or equal to operator for measure objects, where left-hand side may be any object implementing the IMeasure&lt;RelativePermeability&gt; interface
        /// </summary>
        /// <param name="lhs">First object (any object implementing IMeasure&lt;RelativePermeability&gt; interface)</param>
        /// <param name="rhs">Second object</param>
        /// <returns>true if first measure object is less than or equal to second measure object; false otherwise</returns>
        ...
        /// <summary>
        /// Greater than or equal to operator for measure objects, where left-hand side may be any object implementing the IMeasure&lt;RelativePermeability&gt; interface
        /// </summary>
        /// <param name="lhs">First object (any object implementing IMeasure&lt;RelativePermeability&gt; interface)</param>
        /// <param name="rhs">Second object</param>
        /// <returns>true if first measure object is greater than or equal to second measure object; false otherwise</returns>
        ...
        /// <summary>
        /// Equality operator for measure objects, where left-hand side may be any object implementing the IMeasure&lt;RelativePermeability&gt; interface
        /// </summary>
        /// <param name="lhs">First object (any object implementing IMeasure&lt;RelativePermeability&gt; interface)</param>
        /// <param name="rhs">Second object</param>
        /// <returns>true if the two measure objects are equal; false otherwise</returns>
        ...
        /// <summary>
        /// Inequality operator for measure objects, where left-hand side may be any object implementing the IMeasure&lt;RelativePermeability&gt; interface
        /// </summary>
        /// <param name="lhs">First object (any object implementing IMeasure&lt;RelativePermeability&gt; interface)</param>
        /// <param name="rhs">Second object</param>
        /// <returns>true if the two measure objects are not equal; false if they are equal</returns>
        ...
        private class MeasureFactory : IMeasureFactory<RelativePermeability>
        {
            ...
            public IMeasure<RelativePermeability> New(IMeasure<RelativePermeability> measure)
            {
                return new Measure<RelativePermeability>(measure);
            }
            ...
            public IMeasure<RelativePermeability> New(double amount, IUnit<RelativePermeability> unit)
            {
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<RelativePermeability> New(float amount, IUnit<RelativePermeability> unit)
            {
                return new Measure<RelativePermeability>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<RelativePermeability> New(decimal amount, IUnit<RelativePermeability> unit)
            {
                return new Measure<RelativePermeability>(amount, unit);
            }
        }
