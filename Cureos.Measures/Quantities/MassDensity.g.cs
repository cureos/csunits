...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct MassDensity : IQuantity<MassDensity>, IMeasure<MassDensity>
    {
        ...
        /// <summary>
        /// Initializes a MassDensity object from an object implementing the IMeasure&lt;MassDensity&gt; interface
        /// </summary>
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the mass density quantity</typeparam>
        /// </summary
        ...
        public bool Equals(IMeasure<MassDensity> other)
        {
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<MassDensity> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<MassDensity> this[IUnit<MassDensity> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<MassDensity>(this.GetAmount(unit), unit);
            }
        }
        ...
        {
            return String.Format("{0} {1} (mass density)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (mass density)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (mass density)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (mass density)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
