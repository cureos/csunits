...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Length : IQuantity<Length>, IMeasure<Length>
    {
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(Length))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<Length> this[IUnit<Length> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<Length>(this.GetAmount(unit), unit);
            }
        }
        ...
        {
            return String.Format("{0} {1} (length)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (length)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (length)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (length)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
