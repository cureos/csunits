...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Length : IQuantity<Length>, IMeasure<Length>, IEquatable<Length>, IComparable<Length>
    {
        ...
        public static Length operator *(AmountType scalar, Length measure)
        {
            return new Length(scalar * measure.amount);
        }
        ...
        {
            return new Length(measure.amount * scalar);
        }
        ...
        public static Length operator *(IMeasure<Number> scalar, Length measure)
        {
            return new Length(scalar.StandardAmount * measure.amount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(IMeasure<Length> dividend, Length divisor)
        {
        ...
        private class MeasureFactory : IMeasureFactory<Length>
        {
            ...
            public IMeasure<Length> New(IMeasure<Length> measure)
            {
                return new Measure<Length>(measure);
            }
            ...
            public IMeasure<Length> New(double amount, IUnit<Length> unit)
            {
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<Length> New(float amount, IUnit<Length> unit)
            {
                return new Measure<Length>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<Length> New(decimal amount, IUnit<Length> unit)
            {
                return new Measure<Length>(amount, unit);
            }
        }
