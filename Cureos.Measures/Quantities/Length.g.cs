...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Length : IQuantity<Length>, IMeasure<Length>, IEquatable<Length>, IComparable<Length>
    {
        ...
        private static readonly IMeasureFactory<Length> factory = new MeasureFactory();
        ...
        public Length(double amount, IUnit<Length> unit)
        {
        ...
        /// <param name="unit">Unit of measure</param>
        /// <exception cref="ArgumentNullException">if the specified unit is null</exception>
        public Length(float amount, IUnit<Length> unit)
        {
            if (unit == null) throw new ArgumentNullException("unit");
            this.amount = unit.ConvertAmountToStandardUnit((AmountType)amount);
        }
        ...
        /// <param name="unit">Unit of measure</param>
        /// <exception cref="ArgumentNullException">if the specified unit is null</exception>
        public Length(decimal amount, IUnit<Length> unit)
        {
            if (unit == null) throw new ArgumentNullException("unit");
            this.amount = unit.ConvertAmountToStandardUnit((AmountType)amount);
        }
        ...
        #region Implementation of IQuantity<Length>
        ...
        /// </summary>
        IMeasureFactory<Length> IQuantity<Length>.Factory
        { 
            get { return factory; }
        }
        ...
        #region Implementation of IMeasure<Length>
        ...
        /// <exception cref="ArgumentNullException">if specified unit is null or if specified unit is not of the Length quantity.</exception>
        ...
        /// <param name="unit">Unit to which the measured amount should be converted</param>
        /// <returns>Measured amount converted into <paramref name="unit">specified unit</paramref></returns>
        public AmountType GetAmount(IUnit<Length> unit)
        {
            if (unit == null) throw new ArgumentNullException("unit");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        IMeasure<Length> IMeasure<Length>.this[IUnit<Length> unit]
        {
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public Measure<Length> this[IUnit<Length> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new Measure<Length>(this.GetAmount(unit), unit);
            }
        }
        ...
        /// <summary>
        /// Casts a double value to a Length object
        /// </summary>
        /// <param name="standardAmount">Standard amount</param>
        /// <returns>Length representation of <paramref name="standardAmount"/> in unit Meter</returns>
        public static explicit operator Length(double standardAmount)
        {
            return new Length(standardAmount);
        }

        /// <summary>
        /// Casts a float value to a Length object
        /// </summary>
        /// <param name="standardAmount">Standard amount</param>
        /// <returns>Length representation of <paramref name="standardAmount"/> in unit Meter</returns>
        public static explicit operator Length(float standardAmount)
        {
            return new Length(standardAmount);
        }

        /// <summary>
        /// Casts a decimal value to a Length object
        /// </summary>
        /// <param name="standardAmount">Standard amount</param>
        /// <returns>Length representation of <paramref name="standardAmount"/> in unit Meter</returns>
        public static explicit operator Length(decimal standardAmount)
        {
            return new Length(standardAmount);
        }
        ...
        /// <returns>Sum of the two measure objects in the unit of the <paramref name="lhs">left-hand side measure</paramref></returns>
        public static Length operator +(Length lhs, IMeasure<Length> rhs)
        {
        ...
        public static Length operator *(double scalar, Length measure)
        {
            return new Length((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static Length operator *(float scalar, Length measure)
        {
            return new Length((AmountType)scalar * measure.amount);
        }
        ...
        /// <param name="measure">Measure object</param>
        /// <returns>Product of the scalar and the measure object</returns>
        public static Length operator *(decimal scalar, Length measure)
        {
            return new Length((AmountType)scalar * measure.amount);
        }
        ...
        public static Length operator *(Length measure, double scalar)
        {
            return new Length(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static Length operator *(Length measure, float scalar)
        {
            return new Length(measure.amount * (AmountType)scalar);
        }
        ...
        /// <param name="scalar">Floating-point scalar</param>
        /// <returns>Product of the measure object and the scalar</returns>
        public static Length operator *(Length measure, decimal scalar)
        {
            return new Length(measure.amount * (AmountType)scalar);
        }
        ...
        public static Length operator *(Length measure, IMeasure<Number> scalar)
        {
            return new Length(measure.amount * scalar.StandardAmount);
        }
        ...
        public static Number operator /(Length dividend, Length divisor)
        {
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(Length dividend, IMeasure<Length> divisor)
        {
        ...
        /// <summary>
        /// Less than operator for measure objects, where right-hand side may be any object implementing the IMeasure&lt;Length&gt; interface
        /// </summary>
        /// <param name="lhs">First object</param>
        /// <param name="rhs">Second object (any object implementing IMeasure&lt;Length&gt; interface)</param>
        /// <returns>true if first measure object is less than second measure object; false otherwise</returns>
        public static bool operator <(Length lhs, IMeasure<Length> rhs)
        {
            return lhs.amount < rhs.StandardAmount;
        }

        /// <summary>
        /// Less than operator for measure objects, where left-hand side may be any object implementing the IMeasure&lt;Length&gt; interface
        /// </summary>
        /// <param name="lhs">First object (any object implementing IMeasure&lt;Length&gt; interface)</param>
        /// <param name="rhs">Second object</param>
        /// <returns>true if first measure object is less than second measure object; false otherwise</returns>
        public static bool operator <(IMeasure<Length> lhs, Length rhs)
        {
        ...
        /// <summary>
        /// Greater than operator for measure objects, where right-hand side may be any object implementing the IMeasure&lt;Length&gt; interface
        /// </summary>
        /// <param name="lhs">First object</param>
        /// <param name="rhs">Second object (any object implementing IMeasure&lt;Length&gt; interface)</param>
        /// <returns>true if first measure object is greater than second measure object; false otherwise</returns>
        ...
        /// <summary>
        /// Greater than operator for measure objects, where left-hand side may be any object implementing the IMeasure&lt;Length&gt; interface
        /// </summary>
        /// <param name="lhs">First object (any object implementing IMeasure&lt;Length&gt; interface)</param>
        /// <param name="rhs">Second object</param>
        /// <returns>true if first measure object is greater than second measure object; false otherwise</returns>
        ...
        /// <summary>
        /// Less than or equal to operator for measure objects, where right-hand side may be any object implementing the IMeasure&lt;Length&gt; interface
        /// </summary>
        /// <param name="lhs">First object</param>
        /// <param name="rhs">Second object (any object implementing IMeasure&lt;Length&gt; interface)</param>
        /// <returns>true if first measure object is less than or equal to second measure object; false otherwise</returns>
        ...
        /// <summary>
        /// Less than or equal to operator for measure objects, where left-hand side may be any object implementing the IMeasure&lt;Length&gt; interface
        /// </summary>
        /// <param name="lhs">First object (any object implementing IMeasure&lt;Length&gt; interface)</param>
        /// <param name="rhs">Second object</param>
        /// <returns>true if first measure object is less than or equal to second measure object; false otherwise</returns>
        ...
        /// <summary>
        /// Greater than or equal to operator for measure objects, where right-hand side may be any object implementing the IMeasure&lt;Length&gt; interface
        /// </summary>
        /// <param name="lhs">First object</param>
        /// <param name="rhs">Second object (any object implementing IMeasure&lt;Length&gt; interface)</param>
        /// <returns>true if first measure object is greater than or equal to second measure object; false otherwise</returns>
        ...
        /// <summary>
        /// Greater than or equal to operator for measure objects, where left-hand side may be any object implementing the IMeasure&lt;Length&gt; interface
        /// </summary>
        /// <param name="lhs">First object (any object implementing IMeasure&lt;Length&gt; interface)</param>
        /// <param name="rhs">Second object</param>
        /// <returns>true if first measure object is greater than or equal to second measure object; false otherwise</returns>
        ...
        /// <summary>
        /// Equality operator for measure objects, where right-hand side may be any object implementing the IMeasure&lt;Length&gt; interface
        /// </summary>
        /// <param name="lhs">First object</param>
        /// <param name="rhs">Second object (any object implementing IMeasure&lt;Length&gt; interface)</param>
        /// <returns>true if the two measure objects are equal; false otherwise</returns>
        ...
        /// <summary>
        /// Equality operator for measure objects, where left-hand side may be any object implementing the IMeasure&lt;Length&gt; interface
        /// </summary>
        /// <param name="lhs">First object (any object implementing IMeasure&lt;Length&gt; interface)</param>
        /// <param name="rhs">Second object</param>
        /// <returns>true if the two measure objects are equal; false otherwise</returns>
        ...
        /// <summary>
        /// Inequality operator for measure objects, where right-hand side may be any object implementing the IMeasure&lt;Length&gt; interface
        /// </summary>
        /// <param name="lhs">First object</param>
        /// <param name="rhs">Second object (any object implementing IMeasure&lt;Length&gt; interface)</param>
        /// <returns>true if the two measure objects are not equal; false if they are equal</returns>
        ...
        /// <summary>
        /// Inequality operator for measure objects, where left-hand side may be any object implementing the IMeasure&lt;Length&gt; interface
        /// </summary>
        /// <param name="lhs">First object (any object implementing IMeasure&lt;Length&gt; interface)</param>
        /// <param name="rhs">Second object</param>
        /// <returns>true if the two measure objects are not equal; false if they are equal</returns>
        ...
        #region Private class implementation of IMeasureFactory<Length>

        private class MeasureFactory : IMeasureFactory<Length>
        {
            /// <summary>
            ...
            public Length New(double amount)
            {
            ...
            public Length New(double amount, IUnit<Length> unit)
            {
            ...
            /// <param name="amount">Amount.</param>
            /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
            public Length New(float amount)
            {
                return new Length(amount);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Standard unit measure.</returns>
            public Length New(float amount, IUnit<Length> unit)
            {
                return new Length(amount, unit);
            }
            ...
            /// <param name="amount">Amount.</param>
            /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
            public Length New(decimal amount)
            {
                return new Length(amount);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Standard unit measure.</returns>
            public Length New(decimal amount, IUnit<Length> unit)
            {
                return new Length(amount, unit);
            }
            ...
            public IMeasure<Length> NewPreserveUnit(double amount, IUnit<Length> unit)
            {
                return new Measure<Length>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<Length> NewPreserveUnit(float amount, IUnit<Length> unit)
            {
                return new Measure<Length>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<Length> NewPreserveUnit(decimal amount, IUnit<Length> unit)
            {
                return new Measure<Length>(amount, unit);
            }
        }
