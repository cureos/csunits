...
namespace Cureos.Measures.Quantities
{
    ...
    /// </summary>
    public partial struct MagneticFieldStrength : IQuantity<MagneticFieldStrength>, IMeasure<MagneticFieldStrength>
    {
        #region FIELDS
        ...
        /// <summary>
        /// Initializes a MagneticFieldStrength object from an object implementing the IMeasure&lt;MagneticFieldStrength&gt; interface
        /// </summary>
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the magnetic field strength quantity</typeparam>
        /// </summary
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(MagneticFieldStrength))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        public bool Equals(IMeasure<MagneticFieldStrength> other)
        {
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(MagneticFieldStrength))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<MagneticFieldStrength> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<MagneticFieldStrength> this[IUnit<MagneticFieldStrength> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<MagneticFieldStrength>(this.GetAmount(unit), unit);
            }
        }
        ...
        {
            return String.Format("{0} {1} (magnetic field strength)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (magnetic field strength)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (magnetic field strength)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (magnetic field strength)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
