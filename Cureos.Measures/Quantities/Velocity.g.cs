...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct Velocity : IQuantity<Velocity>, IMeasure<Velocity>, 
        IMeasureFactory<Velocity>, IEquatable<Velocity>, IComparable<Velocity>
    {
        #region FIELDS

        private static readonly IMeasureFactory<Velocity> factory = new Velocity();
        ...
        /// </summary>
        public IMeasureFactory<Velocity> Factory
        { 
            get { return factory; }
        }
        ...
        Velocity IMeasureFactory<Velocity>.Create(IMeasure<Velocity> measure)
        {
        ...
        public Velocity Create(double amount)
        {
        ...
        public Velocity Create(double amount, IUnit<Velocity> unit)
        {
        ...
        /// <param name="amount">Amount.</param>
        /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
        public Velocity Create(float amount)
        {
            return new Velocity(amount);
        }
        ...
        /// <param name="unit">Unit.</param>
        /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
        public Velocity Create(float amount, IUnit<Velocity> unit)
        {
            return new Velocity(amount, unit);
        }
        ...
        /// <param name="amount">Amount.</param>
        /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
        public Velocity Create(decimal amount)
        {
            return new Velocity(amount);
        }
        ...
        /// <param name="unit">Unit.</param>
        /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
        public Velocity Create(decimal amount, IUnit<Velocity> unit)
        {
            return new Velocity(amount, unit);
        }
        ...
        public static Velocity operator *(IMeasure<Number> scalar, Velocity measure)
        {
            return new Velocity(scalar.StandardAmount * measure.amount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(IMeasure<Velocity> dividend, Velocity divisor)
        {
