...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct WaveNumber : IQuantity<WaveNumber>, IMeasure<WaveNumber>, IEquatable<WaveNumber>, IComparable<WaveNumber>
    {
        ...
        public static readonly IUnit<WaveNumber> ReciprocalMeter = new Unit<WaveNumber>("m\u207b¹");

        public static readonly IUnit<WaveNumber> ReciprocalCentiMeter = new Unit<WaveNumber>("cm\u207b¹", Factors.Hecto);
        public static readonly IUnit<WaveNumber> ReciprocalMilliMeter = new Unit<WaveNumber>("mm\u207b¹", Factors.Kilo);
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!(unit.Quantity is WaveNumber)) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!(other.Unit.Quantity is WaveNumber)) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
