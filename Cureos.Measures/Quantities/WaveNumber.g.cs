...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct WaveNumber : IQuantity<WaveNumber>, IMeasure<WaveNumber>
    {
        ...
        /// <summary>
        /// Initializes a WaveNumber object from an object implementing the IMeasure&lt;WaveNumber&gt; interface
        /// </summary>
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the wave number quantity</typeparam>
        /// </summary
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(WaveNumber))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        public bool Equals(IMeasure<WaveNumber> other)
        {
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(WaveNumber))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<WaveNumber> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof(IMeasure<WaveNumber>)) return false;
            return this.Equals((IMeasure<WaveNumber>)obj);
        }
        ...
        public static WaveNumber operator *(AmountType scalar, WaveNumber measure)
        {
            return new WaveNumber(scalar * measure.amount);
        }
        ...
        public static WaveNumber operator *(WaveNumber measure, AmountType scalar)
        {
            return new WaveNumber(measure.amount * scalar);
        }
