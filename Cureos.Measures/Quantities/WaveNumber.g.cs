...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct WaveNumber : IQuantity<WaveNumber>, IMeasure<WaveNumber>, IEquatable<WaveNumber>, IComparable<WaveNumber>
    {
        ...
        public static readonly IUnit<WaveNumber> ReciprocalMeter = new ConstantConverterUnit<WaveNumber>("m\u207b¹");

        public static readonly IUnit<WaveNumber> ReciprocalCentiMeter = new ConstantConverterUnit<WaveNumber>("cm\u207b¹", Factors.Hecto);
        public static readonly IUnit<WaveNumber> ReciprocalMilliMeter = new ConstantConverterUnit<WaveNumber>("mm\u207b¹", Factors.Kilo);
        ...
        public IMeasure<WaveNumber> this[IUnit<WaveNumber> unit]
        {
            get
            {
                ...
                return unit.IsStandardUnit
                    ...
                    : new InUnitMeasure<WaveNumber>(this.GetAmount(unit), unit);
            }
        }
