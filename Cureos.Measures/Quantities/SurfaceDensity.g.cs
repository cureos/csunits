...
namespace Cureos.Measures.Quantities
{
    ...
    /// </summary>
    public partial struct SurfaceDensity : IQuantity<SurfaceDensity>, IMeasure<SurfaceDensity>
    {
        #region FIELDS
        ...
        /// <summary>
        /// Initializes a SurfaceDensity object from an object implementing the IMeasure&lt;SurfaceDensity&gt; interface
        /// </summary>
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the surface density quantity</typeparam>
        /// </summary
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(SurfaceDensity))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        public bool Equals(IMeasure<SurfaceDensity> other)
        {
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(SurfaceDensity))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<SurfaceDensity> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<SurfaceDensity> this[IUnit<SurfaceDensity> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<SurfaceDensity>(this.GetAmount(unit), unit);
            }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof(IMeasure<SurfaceDensity>)) return false;
            return this.Equals((IMeasure<SurfaceDensity>)obj);
        }
        ...
        {
            return String.Format("{0} {1} (surface density)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (surface density)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (surface density)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (surface density)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
