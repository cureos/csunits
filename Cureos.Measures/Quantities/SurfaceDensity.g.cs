...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct SurfaceDensity : IQuantity<SurfaceDensity>, IMeasure<SurfaceDensity>, IEquatable<SurfaceDensity>, IComparable<SurfaceDensity>
    {
        ...
        public static readonly IUnit<SurfaceDensity> KiloGramPerSquareMeter = new ConstantConverterUnit<SurfaceDensity>("kg m\u207b²");

        public static readonly IUnit<SurfaceDensity> GramPerSquareCentiMeter = new ConstantConverterUnit<SurfaceDensity>("g cm\u207b²", Factors.Deka);
