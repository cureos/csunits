...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct ElectricConductance : IQuantity<ElectricConductance>, IMeasure<ElectricConductance>, IEquatable<ElectricConductance>, IComparable<ElectricConductance>
    {
        ...
        private static readonly IMeasureFactory<ElectricConductance> factory = new MeasureFactory();
        ...
        /// </summary>
        public IMeasureFactory<ElectricConductance> Factory
        { 
            get { return factory; }
        }
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public Measure<ElectricConductance> this[IUnit<ElectricConductance> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new Measure<ElectricConductance>(this.GetAmount(unit), unit);
            }
        }
        ...
        public static ElectricConductance operator *(ElectricConductance measure, IMeasure<Number> scalar)
        {
            return new ElectricConductance(measure.amount * scalar.StandardAmount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(ElectricConductance dividend, IMeasure<ElectricConductance> divisor)
        {
        ...
        #region Private class implementation of IMeasureFactory<ElectricConductance>

        private class MeasureFactory : IMeasureFactory<ElectricConductance>
        {
            /// <summary>
            ...
            public IMeasure<ElectricConductance> New(IMeasure<ElectricConductance> measure)
            {
                return new Measure<ElectricConductance>(measure);
            }
            ...
            public IMeasure<ElectricConductance> New(double amount, IUnit<ElectricConductance> unit)
            {
                return new Measure<ElectricConductance>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<ElectricConductance> New(float amount, IUnit<ElectricConductance> unit)
            {
                return new Measure<ElectricConductance>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<ElectricConductance> New(decimal amount, IUnit<ElectricConductance> unit)
            {
                return new Measure<ElectricConductance>(amount, unit);
            }
        }
