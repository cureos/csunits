...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct ElectricConductance : IQuantity<ElectricConductance>, IMeasure<ElectricConductance>
    {
        ...
        public static readonly Unit<ElectricConductance> CentiSiemens = new Unit<ElectricConductance>(UnitPrefix.Centi);
        public static readonly Unit<ElectricConductance> DeciSiemens = new Unit<ElectricConductance>(UnitPrefix.Deci);
        ...
        /// <summary>
        /// Initializes a ElectricConductance object from an object implementing the IMeasure&lt;ElectricConductance&gt; interface
        /// </summary>
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the electric conductance quantity</typeparam>
        /// </summary
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(ElectricConductance))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        public bool Equals(IMeasure<ElectricConductance> other)
        {
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(ElectricConductance))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<ElectricConductance> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<ElectricConductance> this[IUnit<ElectricConductance> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<ElectricConductance>(this.GetAmount(unit), unit);
            }
        }
        ...
        {
            return String.Format("{0} {1} (electric conductance)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (electric conductance)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (electric conductance)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (electric conductance)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
