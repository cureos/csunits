...
namespace Cureos.Measures.Quantities
{
    ...
    /// </summary>
    [DataContract]
    public partial struct CurrentDensity : IQuantity<CurrentDensity>, IMeasure<CurrentDensity>
    {
        #region FIELDS
        ...
        public static readonly Unit<CurrentDensity> CentiAmperePerSquareMeter = new Unit<CurrentDensity>(UnitPrefix.Centi);
        public static readonly Unit<CurrentDensity> DeciAmperePerSquareMeter = new Unit<CurrentDensity>(UnitPrefix.Deci);
        ...
        /// <summary>
        /// Initializes a CurrentDensity object from an object implementing the IMeasure&lt;CurrentDensity&gt; interface
        /// </summary>
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the current density quantity</typeparam>
        /// </summary
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(CurrentDensity))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        public bool Equals(IMeasure<CurrentDensity> other)
        {
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(CurrentDensity))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<CurrentDensity> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<CurrentDensity> this[IUnit<CurrentDensity> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<CurrentDensity>(this.GetAmount(unit), unit);
            }
        }
        ...
        {
            return String.Format("{0} {1} (current density)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (current density)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (current density)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (current density)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
