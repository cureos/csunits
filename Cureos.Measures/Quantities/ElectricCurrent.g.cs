...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct ElectricCurrent : IQuantity<ElectricCurrent>, IMeasure<ElectricCurrent>, IMeasureFactory<ElectricCurrent>, IEquatable<ElectricCurrent>, IComparable<ElectricCurrent>
    {
        ...
        public IMeasure<ElectricCurrent> this[IUnit<ElectricCurrent> unit]
        {
            get
            {
                ...
                return unit.IsStandardUnit
                    ...
                    : new InUnitMeasure<ElectricCurrent>(this.GetAmount(unit), unit);
            }
        }
        ...
        public static ElectricCurrent operator *(IMeasure<Number> scalar, ElectricCurrent measure)
        {
            return new ElectricCurrent(scalar.StandardAmount * measure.amount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(IMeasure<ElectricCurrent> dividend, ElectricCurrent divisor)
        {
