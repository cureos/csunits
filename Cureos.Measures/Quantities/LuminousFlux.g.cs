...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct LuminousFlux : IQuantity<LuminousFlux>, IMeasure<LuminousFlux>
    {
        ...
        public static readonly Unit<LuminousFlux> CentiLumen = new Unit<LuminousFlux>(UnitPrefix.Centi);
        public static readonly Unit<LuminousFlux> DeciLumen = new Unit<LuminousFlux>(UnitPrefix.Deci);
        public static readonly Unit<LuminousFlux> DekaLumen = new Unit<LuminousFlux>(UnitPrefix.Deka);
        public static readonly Unit<LuminousFlux> HectoLumen = new Unit<LuminousFlux>(UnitPrefix.Hecto);
        ...
        /// <summary>
        /// Initializes a LuminousFlux object from an object implementing the IMeasure&lt;LuminousFlux&gt; interface
        /// </summary>
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the luminous flux quantity</typeparam>
        /// </summary
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(LuminousFlux))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        public bool Equals(IMeasure<LuminousFlux> other)
        {
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(LuminousFlux))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<LuminousFlux> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<LuminousFlux> this[IUnit<LuminousFlux> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<LuminousFlux>(this.GetAmount(unit), unit);
            }
        }
        ...
        {
            return String.Format("{0} {1} (luminous flux)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (luminous flux)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (luminous flux)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (luminous flux)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
