...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct AmountConcentration : IQuantity<AmountConcentration>, IMeasure<AmountConcentration>, IMeasureFactory<AmountConcentration>, IEquatable<AmountConcentration>, IComparable<AmountConcentration>
    {
        ...
        public AmountConcentration Create(double amount)
        {
        ...
        public AmountConcentration Create(double amount, IUnit<AmountConcentration> unit)
        {
        ...
        /// <param name="amount">Amount.</param>
        /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
        public AmountConcentration Create(float amount)
        {
            return new AmountConcentration(amount);
        }
        ...
        /// <param name="unit">Unit.</param>
        /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
        public AmountConcentration Create(float amount, IUnit<AmountConcentration> unit)
        {
            return new AmountConcentration(amount, unit);
        }
        ...
        /// <param name="amount">Amount.</param>
        /// <returns>Standard unit measure at the specified <paramref name="amount"/>.</returns>
        public AmountConcentration Create(decimal amount)
        {
            return new AmountConcentration(amount);
        }
        ...
        /// <param name="unit">Unit.</param>
        /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
        public AmountConcentration Create(decimal amount, IUnit<AmountConcentration> unit)
        {
            return new AmountConcentration(amount, unit);
        }
        ...
        public IMeasure<AmountConcentration> this[IUnit<AmountConcentration> unit]
        {
            get
            {
                ...
                return unit.IsStandardUnit
                    ...
                    : new InUnitMeasure<AmountConcentration>(this.GetAmount(unit), unit);
            }
        }
        ...
        public static AmountConcentration operator *(IMeasure<Number> scalar, AmountConcentration measure)
        {
            return new AmountConcentration(scalar.StandardAmount * measure.amount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(IMeasure<AmountConcentration> dividend, AmountConcentration divisor)
        {
