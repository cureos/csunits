...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct DoseEquivalent : IQuantity<DoseEquivalent>, IMeasure<DoseEquivalent>, IEquatable<DoseEquivalent>, IComparable<DoseEquivalent>
    {
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(DoseEquivalent))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(DoseEquivalent))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
