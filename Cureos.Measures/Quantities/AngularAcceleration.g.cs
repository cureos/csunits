...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct AngularAcceleration : IQuantity<AngularAcceleration>, IMeasure<AngularAcceleration>, IEquatable<AngularAcceleration>, IComparable<AngularAcceleration>
    {
        ...
        public static AngularAcceleration operator *(IMeasure<Number> scalar, AngularAcceleration measure)
        {
            return new AngularAcceleration(scalar.StandardAmount * measure.amount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(IMeasure<AngularAcceleration> dividend, AngularAcceleration divisor)
        {
        ...
        private class MeasureFactory : IMeasureFactory<AngularAcceleration>
        {
            ...
            public IMeasure<AngularAcceleration> New(IMeasure<AngularAcceleration> measure)
            {
                return new Measure<AngularAcceleration>(measure);
            }
            ...
            public IMeasure<AngularAcceleration> New(double amount, IUnit<AngularAcceleration> unit)
            {
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<AngularAcceleration> New(float amount, IUnit<AngularAcceleration> unit)
            {
                return new Measure<AngularAcceleration>(amount, unit);
            }
            ...
            /// <param name="unit">Unit.</param>
            /// <returns>Measure from the specified <paramref name="amount"/> and <paramref name="unit"/>.</returns>
            public IMeasure<AngularAcceleration> New(decimal amount, IUnit<AngularAcceleration> unit)
            {
                return new Measure<AngularAcceleration>(amount, unit);
            }
        }
