...
namespace Cureos.Measures.Quantities
{
    ...
    /// </summary>
    public partial struct ElectricResistance : IQuantity<ElectricResistance>, IMeasure<ElectricResistance>
    {
        #region FIELDS
        ...
        /// <summary>
        /// Initializes a ElectricResistance object from an object implementing the IMeasure&lt;ElectricResistance&gt; interface
        /// </summary>
        ...
        /// <summary>
        /// Gets the measured amount in the standard unit of measure for the electric resistance quantity</typeparam>
        /// </summary
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!unit.Quantity.Equals(default(ElectricResistance))) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        public bool Equals(IMeasure<ElectricResistance> other)
        {
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!other.Unit.Quantity.Equals(default(ElectricResistance))) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
        ...
        /// </returns>
        /// <param name="other">An object to compare with this object.</param>
        public int CompareTo(IMeasure<ElectricResistance> other)
        {
            if (other == null) throw new ArgumentNullException("other");
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public UnitPreservingMeasure<ElectricResistance> this[IUnit<ElectricResistance> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return new UnitPreservingMeasure<ElectricResistance>(this.GetAmount(unit), unit);
            }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj.GetType() != typeof(IMeasure<ElectricResistance>)) return false;
            return this.Equals((IMeasure<ElectricResistance>)obj);
        }
        ...
        {
            return String.Format("{0} {1} (electric resistance)", this.amount, this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (electric resistance)", this.amount.ToString(format), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (electric resistance)", this.amount.ToString(provider), this.Unit.Symbol).Trim();
        }
        ...
        {
            return String.Format("{0} {1} (electric resistance)", this.amount.ToString(format, provider), this.Unit.Symbol).Trim();
        }
        ...
        public static ElectricResistance operator *(AmountType scalar, ElectricResistance measure)
        {
            return new ElectricResistance(scalar * measure.amount);
        }
        ...
        public static ElectricResistance operator *(ElectricResistance measure, AmountType scalar)
        {
            return new ElectricResistance(measure.amount * scalar);
        }
