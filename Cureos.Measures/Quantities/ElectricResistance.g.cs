...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct ElectricResistance : IQuantity<ElectricResistance>, IMeasure<ElectricResistance>, 
        IMeasureFactory<ElectricResistance>, IEquatable<ElectricResistance>, IComparable<ElectricResistance>
    {
        #region FIELDS

        private static readonly IMeasureFactory<ElectricResistance> factory = new ElectricResistance();
        ...
        /// </summary>
        public IMeasureFactory<ElectricResistance> Factory
        { 
            get { return factory; }
        }
        ...
        /// </summary>
        /// <param name="unit">Unit in which the new measure should be specified</param>
        public IMeasure<ElectricResistance> this[IUnit<ElectricResistance> unit]
        {
            get
            {
                if (unit == null) throw new ArgumentNullException("unit");
                return unit.IsStandardUnit
                    ? (IMeasure<ElectricResistance>)this
                    : new InUnitMeasure<ElectricResistance>(this.GetAmount(unit), unit);
            }
        }
        ...
        public static ElectricResistance operator *(IMeasure<Number> scalar, ElectricResistance measure)
        {
            return new ElectricResistance(scalar.StandardAmount * measure.amount);
        }
        ...
        /// <param name="divisor">Divisor of same quantity as dividend</param>
        /// <returns>Quotient of the two measure objects</returns>
        public static Number operator /(IMeasure<ElectricResistance> dividend, ElectricResistance divisor)
        {
