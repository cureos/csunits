...
namespace Cureos.Measures.Quantities
{
    ...
    public partial struct ElectricResistance : IQuantity<ElectricResistance>, IMeasure<ElectricResistance>, IEquatable<ElectricResistance>, IComparable<ElectricResistance>
    {
        ...
        {
            if (unit == null) throw new ArgumentNullException("unit");
            if (!(unit.Quantity is ElectricResistance)) throw new ArgumentException("Unit is not the same quantity as measure");
        ...
        bool IEquatable<IMeasure>.Equals(IMeasure other)
        {
            ...
            if (!(other.Unit.Quantity is ElectricResistance)) throw new ArgumentException("Measures are of different quantities");
            return this.amount.Equals(other.GetAmount(this.Unit));
        }
