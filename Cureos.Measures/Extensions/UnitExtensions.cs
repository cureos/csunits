            ...
            smUnitDetailsMap = new UnitDetails[]
                                   {
                                       ...
                                       new UnitDetails(Unit.CubicCentiMeter, Quantity.Volume, "cm³",
                                                       (AmountType) 0.000001),
                                       new UnitDetails(Unit.KiloGram, Quantity.Mass, "kg"),
                                       new UnitDetails(Unit.Tonne, Quantity.Mass, "t", (AmountType) 1000.0),
                                       new UnitDetails(Unit.HectoGram, Quantity.Mass, "g", (AmountType) 0.1),
                                       ...
                                       new UnitDetails(Unit.Celsius, Quantity.Temperature, "°C",
                                                       a => a + (AmountType) 273.15, a => a - (AmountType) 273.15),
